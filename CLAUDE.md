...
- [ ] **Rechtliche Endfassung von Klotzenbuecher/Maisel einholen** (Werkvertrag § 2 Abs. 6). Der Text ist abnahmefaehig, die Freigabe steht aus. **Eine Frage muss die Kanzlei beantworten, sie steht ausformuliert im JSDoc von `Barrierefreiheit.jsx`:** Ist die DVM ueberhaupt verpflichtet? § 3 Abs. 3 BFSG nimmt **Kleinstunternehmen** aus, die Dienstleistungen erbringen (§ 2 Nr. 17: unter 10 Beschaeftigte **und** hoechstens 2 Mio. € Umsatz oder Bilanzsumme) — die Mitarbeiterzahl der DVM ist uns nicht bekannt. Und § 2 Nr. 26 verlangt fuer „Dienstleistung im elektronischen Geschaeftsverkehr", dass sie „im Hinblick auf den Abschluss eines Verbrauchervertrags" erbracht wird; diese Website informiert und fuehrt zu einem Beratungstermin, ein Vertrag wird auf ihr nicht geschlossen. Versicherungsvermittlung ist in § 1 Abs. 3 BFSG auch nicht eigens genannt. Faellt beides negativ aus, ist die Seite eine **freiwillige** Zusicherung; dann muss nur der Abschnitt „Rechtsgrundlage" umformuliert werden, der Rest kann stehen bleiben.
