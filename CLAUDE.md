...
- [ ] **Einzige Zahl ohne Beleg: „50 % aller Scheidungsanträge erfolgen durch die Frau"** (Unterseite Scheidung). Real eher 51 bis 53 %, die Scheidungs-Pressemitteilung weist den Antragsteller nicht nach Geschlecht aus. Bewusst stehen gelassen (Entscheidung Felix, 04.08.2026). Zu belegen wäre sie über die Fachserie „Statistik der rechtskräftigen Beschlüsse in Ehesachen"; dann aber korrekt als „mehr als die Hälfte" formulieren. **Jeder Build meldet sie als Warnung**, siehe unten.
