// Automatisch aus src/pages/Scheidung.jsx geloest (scripts/extract-topic.mjs).
// Reine Daten, kein JSX — damit derselbe Inhalt aus Sanity kommen kann.
// Nicht uebernommen (enthielt Auszeichnung): afterHero, afterQuote, faq, actionsHeadline, ctaHeadline
...
export const inhalt = {
  ...
  ctaBody: `Ob das Verfahren noch vor dir liegt, gerade läuft oder bereits abgeschlossen ist: Gemeinsam verschaffen wir dir Klarheit über deine Altersvorsorge, deine Versicherungen und die nächsten sinnvollen Schritte. {minuten} Minuten. Kostenlos. Vertraulich. Auf Augenhöhe.`,
};
